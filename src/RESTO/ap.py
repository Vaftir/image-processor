...
def main():
    ...
    output_image_label = ttk.Label(frame, style="TLabel", relief="solid", borderwidth=1, width=400, height=300)
    ...
    button_save_image_with_rectangle.grid(row=2, column=0, pady=(10, 10))

    button_crop_image = ttk.Button(frame, text="Cortar Imagem", command=image_processor.crop_image, style="TButton")
    button_crop_image.grid(row=3, column=0, pady=(10, 10))
    ...
    button_remove_bg_with_rect.grid(row=4, column=0, pady=(10, 10))
    ...
    button_remove_bg_cropped.grid(row=5, column=0, pady=(10, 10))
